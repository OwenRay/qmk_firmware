...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_AUX] = LAYOUT(
        KC_VOLU,KC_MEDIA_PLAY_PAUSE,KC_MEDIA_PREV_TRACK,KC_MEDIA_NEXT_TRACK,_______,_______,                 _______,_______,_______,_______,_______,DF(_QWERTY),
	KC_VOLD,RGB_MOD            ,_______            ,_______            ,_______,_______,                 _______, KC_7,  KC_8,   KC_9,   KC_PAST,_______,
	...
	_______,_______,            _______,            _______,            _______,_______,_______,_______, _______, KC_1,  KC_2,   KC_3,   KC_PSLS,_______,
        _______,_______,            _______,            _______,            _______,_______,_______,_______, _______,_______,KC_DOT, KC_0,   KC_PEQL,_______
    ),
  ...
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, KC_SPC,    KC_SPC,   KC_SPC,  KC_SPC,  RAISE,   KANA,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
